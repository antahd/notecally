...
def create_layout():
    ...
    event_name_label = tk.Label(bottom_frame, text="Tapahtuman nimi:", bg="#A7D8DE", font=("Arial", TEXT_FONT_SIZE))  
    ...
    event_name_entry = tk.Entry(bottom_frame, bg="#95acac", bd=0, highlightthickness=0, font=("Arial", TEXT_FONT_SIZE))
    bottom_frame.after(100, position_event_name_entry)

    event_date_label = tk.Label(bottom_frame, text="Tapahtuman päivämäärä (MM-DD):", bg="#a7d8de", font=("Arial", TEXT_FONT_SIZE))
    ...
    event_date_entry = tk.Entry(bottom_frame, bg="#95acac", bd=0, highlightthickness=0, font=("Arial", TEXT_FONT_SIZE))
    bottom_frame.after(100, position_event_date_entry)

    event_description_label = tk.Label(bottom_frame, text="Tapahtuman kuvaus:", bg="#a7d8de", font=("Arial", TEXT_FONT_SIZE))
    ...
    event_description_entry = tk.Entry(bottom_frame, bg="#95acac", bd=0, highlightthickness=0, font=("Arial", TEXT_FONT_SIZE))
